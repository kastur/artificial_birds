...
class ArtificialBirds : public PlatformDemoApplication
{
public:
...
#define MACRO_SOFT_DEMO(a) class ArtificialBirds##a : public ArtificialBirds\
{\
public:\
	static DemoApplication* Create()\
	{\
		ArtificialBirds* demo = new ArtificialBirds##a;\
